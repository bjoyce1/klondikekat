  ...
  return (
    <section className="grain relative isolate overflow-hidden border-b border-border bg-surface">
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-20">
        ...
        <h1 className="mt-3 text-4xl text-balance sm:mt-4 sm:text-7xl lg:text-8xl">
          <span className="text-gold">{title}</span>
        </h1>
        {lead && (
          <p className="mt-4 max-w-2xl text-base text-pretty text-muted-foreground sm:mt-6 sm:text-lg">
            {lead}
          </p>
        )}
        {children}
